...
export default function Micropigmentation() {
  return (
    <div
      className=" w-full bg-background-color pt-8 text-center lg:h-fit lg:pt-20"
      id="anchor"
    >
      <motion.div
      ...
      <div className={montserrat400.className}>
        ...
        <p className="mx-4 pt-8 text-sm lg:mx-16 lg:pt-16  lg:text-3xl">
          ...
          pigmento específico por meio de aparelho invasivo chamado dermógrafo.
        </p>
        <p className="mx-4 pt-3 text-sm lg:mx-16 lg:pt-16  lg:text-3xl">
          ...
          efeitos sombreados ou fios de que imitam os próprios fios naturais. É
          importante realizar o design e um projeto a lápis, antes de iniciar o
